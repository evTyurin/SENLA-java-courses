...
public class OrderDAO implements IOrderDAO{
    ...
    @Override
    public List<Order> importOrdersFromCsv(String path) {
    ...
    @Override
    public void exportOrdersToCsv(List<Order> orders, String path) {
    ...
    @Override
    public List<Order> importOrdersFromJson(String path) {

        return jsonReader.readEntities(Order.class, path);
    }

    @Override
    public void exportOrdersToJson(List<Order> orders, String path) {
        jsonWriter.writeEntities(orders, path);
    }
}